// ==UserScript==
// @name         Stylus - PK linkedin
// @namespace    https://local.stylus.import
// @version      1.0.1
// @description  Imported from Stylus export (id=35, sha1=d94de935)
// @match        *://*/*
// @grant        GM_addStyle
...
(function () {
  ...
  const ok = (
    matchAny(["https://www.linkedin.com/messaging/thread/2-NmE0NGQ5OWEtMGNhMy00N2FmLTg5NDktYzEwMjhiMTBjMGY1XzAxMg==/"], (p) => href.startsWith(p))
  );
  return ok;
  };
  if (!shouldRun()) return;
