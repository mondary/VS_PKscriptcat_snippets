// ==UserScript==
// @name         Stylus - mobile.free.fr/
// @namespace    https://local.stylus.import
// @version      1.0.1
// @description  Imported from Stylus export (id=32, sha1=13c4976b)
// @match        *://*/*
// @grant        GM_addStyle
...
(function () {
  ...
  const ok = (
    matchAny(["https://mobile.free.fr/"], (p) => href.startsWith(p))
  );
  return ok;
  };
  if (!shouldRun()) return;

  let css = ".tns-horizontal.tns-calc.tns-subpixel.tns-carousel.tns-slider.grid-c.my-slider-banner.w-4\n{ display: none \n}";
